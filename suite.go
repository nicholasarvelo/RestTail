...
func (c *Client) GetSuite(suiteID int) (Suite, error) {
	...
	err := c.sendRequest(
		"GET",
		"get_suite/"+strconv.Itoa(suiteID),
		nil,
		&returnSuite,
	)
...
func (c *Client) GetSuites(projectID int) ([]Suite, error) {
	...
	err := c.sendRequest(
		"GET",
		"get_suites/"+strconv.Itoa(projectID),
		nil,
		&returnSuite,
	)
	return returnSuite, err
...
func (c *Client) AddSuite(projectID int, newSuite SendableSuite) (
	Suite,
	error,
) {
	createdSuite := Suite{}
	err := c.sendRequest(
		"POST",
		"add_suite/"+strconv.Itoa(projectID),
		newSuite,
		&createdSuite,
	)
...
func (c *Client) UpdateSuite(suiteID int, update SendableSuite) (Suite, error) {
	...
	err := c.sendRequest(
		"POST",
		"update_suite/"+strconv.Itoa(suiteID),
		update,
		&updatedSuite,
	)
...
func (c *Client) DeleteSuite(suiteID int) error {
	return c.sendRequest(
		"POST",
		"delete_suite/"+strconv.Itoa(suiteID),
		nil,
		nil,
	)
}